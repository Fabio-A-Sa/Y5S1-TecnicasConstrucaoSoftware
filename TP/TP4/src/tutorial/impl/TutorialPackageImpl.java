...
public class TutorialPackageImpl extends EPackageImpl implements TutorialPackage {
	 ...
	 */
	@Override
	public EOperation getMember__AtMostTwoLoans__DiagnosticChain_Map() {
	 ...
	 */
	@Override
	public EOperation getMember__UniqueLoans__DiagnosticChain_Map() {
	...
	public void createPackageContents() {
		...
		createEOperation(memberEClass, MEMBER___AT_MOST_TWO_LOANS__DIAGNOSTICCHAIN_MAP);
		createEOperation(memberEClass, MEMBER___UNIQUE_LOANS__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getBook__SufficientCopies__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "SufficientCopies", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getMember__AtMostTwoLoans__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "AtMostTwoLoans", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getMember__UniqueLoans__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "UniqueLoans", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getMember__UniqueLoans__DiagnosticChain_Map(),
		   source,
		   new String[] {
